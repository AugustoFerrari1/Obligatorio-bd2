...
CREATE TABLE transferencia (
    idAgente        INT             NOT NULL,
    emailOrigen     VARCHAR(100)    NOT NULL,
...
CREATE TABLE comunidad (
    ...
    archivado       CHAR(1)         NOT NULL DEFAULT 'N',
    fechaArchivado  DATE,
...
CREATE TABLE Publicacion (
    ...
    fechaCreacion   DATE            NOT NULL,
    horaCreacion    TIME            NOT NULL,
    votosTotales    INT             NOT NULL DEFAULT 0,
    idComunidad     INT             NOT NULL,
...
CREATE TABLE vota (
    ...
    CONSTRAINT fk_vota_agente       FOREIGN KEY (idAgente)
        REFERENCES Agente(idAgente),
    CONSTRAINT fk_vota_publicacion  FOREIGN KEY (idPublicacion)
        REFERENCES Publicacion(idPublicacion)
);
